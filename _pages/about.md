...
<section class="interests-chapter paper-chapter" id="personal-interests" aria-labelledby="interests-title">
  ...
  <div class="interests-grid">
    <article class="interest-card floating-card" data-reveal>
      ...
      <div class="interest-art football-gallery" role="group" aria-label="City icons — open a photograph">
        ...
        <a class="photo-print player-photo" href="{{ '/images/interests/football/de-bruyne.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Kevin De Bruyne photograph (opens in a new tab)"><img src="{{ '/images/interests/football/de-bruyne.jpg' | relative_url }}" alt="Kevin De Bruyne playing for Manchester City" width="500" height="625" loading="lazy" decoding="async"><span class="photo-caption"><small class="mono">THE VISION</small><strong>Kevin<br>De Bruyne</strong></span></a>
        <a class="photo-print player-photo" href="{{ '/images/interests/football/rodri.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Rodri photograph (opens in a new tab)"><img src="{{ '/images/interests/football/rodri.jpg' | relative_url }}" alt="Rodri in Manchester City's sky-blue kit" width="542" height="932" loading="lazy" decoding="async"><span class="photo-caption"><small class="mono">THE ANCHOR</small><strong>Rodri</strong></span></a>
      </div>
    ...
    <article class="interest-card floating-card" data-reveal>
      ...
      <div class="interest-art gaming-gallery" role="group" aria-label="Game characters — open an image">
        ...
        <a class="photo-print game-photo game-photo--arthur" href="{{ '/images/interests/games/arthur-morgan.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Arthur Morgan artwork (opens in a new tab)"><img src="{{ '/images/interests/games/arthur-morgan.jpg' | relative_url }}" alt="Official red-and-gold Arthur Morgan artwork from Red Dead Redemption 2" width="1080" height="1080" loading="lazy" decoding="async"><span class="photo-caption"><small class="mono">RED DEAD REDEMPTION 2</small><strong>Arthur<br>Morgan</strong></span></a>
      </div>
    ...
    <article class="interest-card floating-card" data-reveal>
      ...
      <div class="interest-art album-gallery" role="group" aria-label="Record shelf — open an album cover">
        ...
        <a class="album-cover" href="{{ '/images/interests/albums/stereophonics.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Stereophonics — Performance and Cocktails cover (opens in a new tab)"><img src="{{ '/images/interests/albums/stereophonics.jpg' | relative_url }}" alt="Stereophonics — Performance and Cocktails album cover" width="600" height="600" loading="lazy" decoding="async"><span class="album-caption">Stereophonics<small>Performance and Cocktails</small></span></a>
        <a class="album-cover" href="{{ '/images/interests/albums/blur.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Blur — Parklife cover (opens in a new tab)"><img src="{{ '/images/interests/albums/blur.jpg' | relative_url }}" alt="Blur — Parklife album cover" width="440" height="440" loading="lazy" decoding="async"><span class="album-caption">Blur<small>Parklife</small></span></a>
        <a class="album-cover" href="{{ '/images/interests/albums/queen.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Queen — A Night at the Opera cover (opens in a new tab)"><img src="{{ '/images/interests/albums/queen.jpg' | relative_url }}" alt="Queen — A Night at the Opera album cover" width="240" height="238" loading="lazy" decoding="async"><span class="album-caption">Queen<small>A Night at the Opera</small></span></a>
        <a class="album-cover" href="{{ '/images/interests/albums/guns-n-roses.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Guns N’ Roses — Appetite for Destruction cover (opens in a new tab)"><img src="{{ '/images/interests/albums/guns-n-roses.jpg' | relative_url }}" alt="Guns N’ Roses — Appetite for Destruction skull-cross album cover" width="352" height="352" loading="lazy" decoding="async"><span class="album-caption">Guns N’ Roses<small>Appetite for Destruction</small></span></a>
        <a class="album-cover" href="{{ '/images/interests/albums/suede.jpg' | relative_url }}" target="_blank" rel="noopener noreferrer" aria-label="View Suede — Coming Up cover (opens in a new tab)"><img src="{{ '/images/interests/albums/suede.jpg' | relative_url }}" alt="Suede — Coming Up album cover" width="250" height="250" loading="lazy" decoding="async"><span class="album-caption">Suede<small>Coming Up</small></span></a>
      </div>
  ...
  <div class="interest-gallery-note mono"><span>ON THE PITCH / IN ANOTHER WORLD / ON REPEAT</span><span>SELECT AN IMAGE TO VIEW IT FULL SIZE ↗</span></div>
  <details class="interest-credits">
    <summary>Image credits &amp; sources</summary>
    <div class="interest-credit-grid">
      <div><h3>Football photography</h3><p><a href="https://commons.wikimedia.org/wiki/File:Erling-Haaland-2023.jpg" target="_blank" rel="noopener noreferrer">Erling Haaland</a> and <a href="https://commons.wikimedia.org/wiki/File:Yokohama_F._Marinos_-_Manchester_City_(3-5)_-_53075487835_(Rodri)_(cropped).jpg" target="_blank" rel="noopener noreferrer">Rodri</a>: pantkiewicz (Patryk Antkiewicz), <a href="https://creativecommons.org/licenses/by-sa/2.0/" target="_blank" rel="noopener noreferrer">CC BY-SA 2.0</a>; existing crops by NullReason and Guyrichtheman.</p><p><a href="https://commons.wikimedia.org/wiki/File:2021-12-07_Fu%C3%9Fball,_M%C3%A4nner,_UEFA_Champions_League,_RB_Leipzig_-_Manchester_City_FC_1DX_2723_by_Stepro_(cropped).jpg" target="_blank" rel="noopener noreferrer">Kevin De Bruyne</a>: Steffen Prößdorf, <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener noreferrer">CC BY-SA 4.0</a>; existing crop by PFHLai, Wikimedia thumbnail. Files unchanged; card framing crops their display.</p></div>
      <div><h3>Game imagery</h3><p>Grace Ashcroft: <a href="https://www.capcom.co.jp/ir/english/data/oar/2025/re-requiem.html" target="_blank" rel="noopener noreferrer">Capcom — Resident Evil Requiem</a>. Arthur Morgan: <a href="https://store.rockstargames.com/game/buy-red-dead-redemption-2" target="_blank" rel="noopener noreferrer">Rockstar Games — Red Dead Redemption 2</a>.</p><p>Game images and album artwork belong to their respective rights holders and are shown here to identify personal interests. No endorsement is implied.</p></div>
      <div><h3>Record sleeve sources</h3><p><a href="https://oasisinet.com/music-category/albums/" target="_blank" rel="noopener noreferrer">Oasis</a> · <a href="https://www.stereophonics.com/" target="_blank" rel="noopener noreferrer">Stereophonics</a> · <a href="https://blur.lnk.to/Parklife" target="_blank" rel="noopener noreferrer">Blur</a> · <a href="https://www.queenonline.com/music" target="_blank" rel="noopener noreferrer">Queen</a> · <a href="https://shop.universalmusic.it/products/guns-n-roses-appetite-for-destruction-vinile" target="_blank" rel="noopener noreferrer">Guns N’ Roses / Universal Music</a> · <a href="https://www.suede.co.uk/homepage/" target="_blank" rel="noopener noreferrer">Suede</a></p><p>Full source notes: <a href="{{ '/images/interests/football/SOURCES.md' | relative_url }}">photographs</a> · <a href="{{ '/images/interests/games/SOURCES.md' | relative_url }}">games</a> · <a href="{{ '/images/interests/albums/SOURCES.md' | relative_url }}">albums</a>.</p></div>
    </div>
  </details>
</section>
